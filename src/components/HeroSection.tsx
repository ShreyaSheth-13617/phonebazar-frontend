    ...
    <section className="py-24 px-4">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold text-foreground leading-tight mb-6">
          Buy & Sell Verified Phones
          <br />
          <span className="text-primary">with Confidence</span>
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
          India's most trusted marketplace for pre-owned smartphones. Every device verified, every transaction secured.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/browse"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-primary text-primary-foreground font-semibold text-lg hover:opacity-90 transition"
          >
            Browse Phones <ArrowRight className="h-5 w-5" />
          </Link>
          <Link
            to="/signup?role=seller"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border border-border text-foreground font-semibold text-lg hover:bg-secondary transition"
          >
