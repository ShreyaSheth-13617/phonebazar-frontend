...
const sidebarItems = [
    ...
    { label: "Escrow Hub", path: "/admin/payments", icon: Banknote },
      ...
      <aside className="w-60 border-r border-border bg-card shrink-0 hidden md:block">
        <div className="p-4">
          ...
          <nav className="space-y-1">
            {sidebarItems.map((item) => (<Link key={item.path} to={item.path} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition ${location.pathname === item.path
